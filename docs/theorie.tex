...
\subsection{Unity 3D Programmierumgebung}\footfullcite{unity3doverview}
...
Gemäss Vorgabe verfasste ich den schriftlichen Teil der Arbeit in LaTeX\footfullcite{latex}.
...
Im Folgenden möchte ich wichtige Fachbegriffe, die noch nicht erwähnt wurden, kurz erläutern. \footfullcite{unity3dglossary}
